...
def Init():
    ...
    info_tables['공고일반'].append(['공고종류', '게시일시', '입찰공고번호', '참조번호', '공고명', '공고기관', '수요기관', '공고담당자', '집행관','검사','검수','입찰방식','낙찰방법','계약방법','국제입찰구분','재입찰', '대화참여자수', '채권자명','발주계획통합번호',
                                '사전규격등록번호','사전규격 미공개사유','국내/국제 입찰사유','WTO수의계약사유', '입찰자격', '연구개발물품여부', '관련공고'])
    info_tables['입찰집행 및 진행 정보'].append(['입찰개시일시', '입찰마감일시', '개찰(입찰)일시', '물품등록구분', '개찰(입찰)일시','개찰장소','입찰참가자격등록\n마감일시','보증서접수마감일시','실적심사신청서','실적심사신청서\n신청기한','공동수급협정서\n접수여부', '공동수급협정서\n마감일시', '규격서 제출방식', '규격서 제출시작일시', '규격서 제출마감일시', '동가입찰 낙찰자\n자동추첨프로그램','SW사업 가격점수\n선정방식 적용여부', '연구개발물품여부'])
    info_tables['예정가격 결정 및 입찰금액 정보'].append(['예가방법', '추첨번호공개여부', '사업금액\n(추정가격 + 부가세)', '추정가격', '배정예산'])
    # info_tables['기본제안서 제출 및 공동수급협정 정보'].append(['전자제출', '기본제안서\n제출시작일시', '기본제안서\n제출마감일시', '공동수급협정서\n접수여부','공동수급협정서\n마감일시'])
    ...
    # info_tables['최종제안요청서 교부내용'].append['최종제안서 제출시작일시','최종제안서 제출마감일시','입찰서개시일시','개찰(입찰)일시','개찰장소','입찰참가자격등록 마감일시', '보증서접수마감일시', '동가입찰 낙찰자 자동추첨프로그램']
    # info_tables['최종제안요청서 교부 첨부파일'].append(['No.','문서구분','파일명'])
